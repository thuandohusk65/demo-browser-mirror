...
) : Dialog(ContextThemeWrapper(mContext, R.style.Theme_Translucent_NoTitleBar)) {
//    mContext,
            ...
            adView = when (type) {
                1 -> {
                    LayoutInflater.from(context)
                        .inflate(com.nhnextsoft.control.R.layout.native_exit_a,
                ...
                2 -> {
                    ...
                    LayoutInflater.from(context)
                        .inflate(com.nhnextsoft.control.R.layout.native_exit_b,
                            null) as NativeAdView
                }
            }
        }
        mFrameLayout.addView(adView)
        Admod.instance?.populateUnifiedNativeAdView(context, nativeAd, adView!!)
